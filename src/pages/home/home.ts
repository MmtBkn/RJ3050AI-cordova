...
export class HomePage {
  ...
  getPrinters() {
    ...
    let BP = cordova.plugins.brotherPrinter;

    BP.findNetworkPrinters(s => {
      alert(s.length > 0 ? 'Devices found!' : 'No device found.')
      s.length > 0 && alert(JSON.stringify(s))
      s[0] && BP.setPrinter(s[0], s => {
        alert('Device is set!')
        BP.printViaSDK(this.data, () => {
